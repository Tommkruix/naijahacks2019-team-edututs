...
public class Bg_U_ListViewAdapter_OnlineTest extends BaseAdapter {

    //variables
    Context mContext;
    LayoutInflater inflater;
    List<Bg_U_Model_OnlineTest> modellist;
    ArrayList<Bg_U_Model_OnlineTest> arrayList;

    //  constuctor


    public Bg_U_ListViewAdapter_OnlineTest(Context context, List<Bg_U_Model_OnlineTest> modellist) {
        mContext = context;
        this.modellist = modellist;
        inflater = LayoutInflater.from(mContext);
        this.arrayList = new ArrayList<Bg_U_Model_OnlineTest>();
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        if (view==null){
            ...
            view = inflater.inflate(R.layout.content_bg_u_designrow_online_test, null);
        ...
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (modellist.get(position).getTitle().equals("Unilorin")){
                    Intent intent = new Intent(mContext, OnlineTestUnilorin.class);
    ...
    public void filter(String charText){
        ...
        if (charText.length()==0){
            ...
            for (Bg_U_Model_OnlineTest model : arrayList){
