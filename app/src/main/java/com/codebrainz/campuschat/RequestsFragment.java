...
public class RequestsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mShimmerViewContainer = RequestsFragmentView.findViewById(R.id.shimmer_view_container);
                                        ...
                                        UsersRef.child(list_user_id).addValueEventListener(new ValueEventListener() {
                                            ...
                                            public void onDataChange(DataSnapshot dataSnapshot) {
                                                if (dataSnapshot.hasChild("image")){
                                                    ...
                                                    Picasso.get().load(requestUserImage).placeholder(R.drawable.a).into(holder.profileImage);
                                                }
                                            ...
                                            public void onDataChange(DataSnapshot dataSnapshot) {
                                                ...
                                                holder.itemView.setOnClickListener(new View.OnClickListener() {
                                                    ...
                                                    public void onClick(View v) {
                                                        ...
                                                        AlertDialog.Builder builder = new AlertDialog.Builder(getContext());
                                                        builder.setTitle("Sent Chat Request");
