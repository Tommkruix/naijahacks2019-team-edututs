...
public class OnlineTestEdePoly extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.main_online_test_edepoly);

        textViewHighscore = findViewById(R.id.textView_highscore);
        spinnerDifficulty = findViewById(R.id.spinner_difficulty);

        String[] difficultyLevels = EdePolyQuestion.getAllDifficultyLevels();
    ...
    private void startTest() {
        ...
        Intent i = new Intent(OnlineTestEdePoly.this, OnlineTestEdePolyQ1.class);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data){
        ...
        if(requestCode == REQUEST_CODE_TEST){
            if(resultCode == RESULT_OK){
                int score = data.getIntExtra(OnlineTestEdePolyQ1.EXTRA_SCORE, 0);
                if(score > highscore){
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_dashboard) {
            Intent i = new Intent(OnlineTestEdePoly.this, Bg_OnlineTest.class);
            startActivity(i);
