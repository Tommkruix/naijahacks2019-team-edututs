...
public class OnlineTestUnilorinQ1 extends AppCompatActivity {
    ...
    private ArrayList<UnilorinQuestion> unilorinQuestionList;
    private int questionCounter;
    private int questionCountTotal;
    private UnilorinQuestion currentQuestion;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.main_q1_online_test_unilorin);
        ...
        String difficulty = intent.getStringExtra(OnlineTestUnilorin.EXTRA_DIFFICULTY);

        textViewDifficulty.setText("Test Mode: " + difficulty);

        if(savedInstanceState == null) {
            OnlineTestDbHelper onlineTestDbHelper = new OnlineTestDbHelper(this);
            unilorinQuestionList = onlineTestDbHelper.getUnilorinQuestions(difficulty);
            questionCountTotal = unilorinQuestionList.size();
            Collections.shuffle(unilorinQuestionList);

            showNextQuestion();
        }else {
            unilorinQuestionList = savedInstanceState.getParcelableArrayList(KEY_QUESTION_LIST);
            /*if (unilorinQuestionList == null){
                finish();
            }*/
            questionCountTotal = unilorinQuestionList.size();
            questionCounter = savedInstanceState.getInt(KEY_QUESTION_COUNT);
            currentQuestion = unilorinQuestionList.get(questionCounter - 1);
            ...
            public void onClick(View view) {
                ...
                if(!answered) {
                    if(rb1.isChecked() || rb2.isChecked() || rb3.isChecked()){
                        ...
                        Toast.makeText(OnlineTestUnilorinQ1.this, "Please select an answer", Toast.LENGTH_SHORT).show();
                    }
                } else {
                   showNextQuestion();
                }
    ...
    private void showThankYouDialog() {
        ...
        grade_text.setText("You've successfully attempt the CampusChat Online Test. We assured you " + Math.round((score*pg)/questionCountTotal) + "% of getting this score in your Unilorin Realtime Examination.");
    ...
    private void showNextQuestion() {
        ...
        if(questionCounter < questionCountTotal){
            currentQuestion = unilorinQuestionList.get(questionCounter);
   ...
   public void onBackPressed() {
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putParcelableArrayList(KEY_QUESTION_LIST, unilorinQuestionList);
    }
}
